  ...
  ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
    ...
    for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
      ...
      if (buttonName === 'title') {
        ...
        children.push(Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])("button", {
          type: "button",
          ...
          onClick: buttonClick
        }, buttonText || (buttonIcon ? Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])("span", {
  ...
  */
  ...
  CalendarContent.prototype.render = function () {
    ...
    return Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(ViewContextType.Provider, {
      value: viewContext
    }, toolbarConfig.header && Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(Toolbar, Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__assign"])({
      ref: this.headerRef,
    ...
    }, this.renderView(props), this.buildAppendContent()), toolbarConfig.footer && Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(Toolbar, Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__assign"])({
      ref: this.footerRef,
  ...
  StandardEvent.prototype.render = function () {
    ...
    return Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(EventRoot, {
      ...
      return Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])("a", Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__assign"])({
        ...
        ref: rootElRef
      }, getSegAnchorAttrs(seg, context)), Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
...
function (_super) {
  ...
  MoreLinkRoot.prototype.render = function () {
    ...
    return Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(ViewContextType.Consumer, null, function (context) {
      ...
      }), state.isPopoverOpen && Object(_vdom_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(MorePopover, {
        id: state.popoverId,
    ...
    return Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["EventRoot"], {
      ...
      return (// we don't use styles!
        Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["createElement"])("a", Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__assign"])({
          ...
          ref: rootElRef
        }, Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["getSegAnchorAttrs"])(props.seg, context)), innerContent)
      );
    });
  };
...
function (_super) {
  ...
  TableCellMoreLink.prototype.render = function () {
    ...
    return Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["MoreLinkRoot"], {
      ...
      }, Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["createAriaClickAttrs"])(handleClick)), innerContent);
    });
  };
...
function (_super) {
  ...
  Table.prototype.render = function () {
    ...
    return Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
      ...
      }, props.colGroupNode, Object(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_1__["createElement"])("tbody", {
        role: "presentation"
...
var mission_id = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_4___default()();
/**
...
var EventFragment = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    return m("div", null, m("p", {
      ...
      config: m.route
    }, flarum_helpers_username__WEBPACK_IMPORTED_MODULE_3___default()(this.attrs.event.user()))), m("p", null, "D\xE9but : ", flarum_helpers_fullTime__WEBPACK_IMPORTED_MODULE_9___default()(this.attrs.event.event_start()), " ", m("br", null), "Fin : ", flarum_helpers_fullTime__WEBPACK_IMPORTED_MODULE_9___default()(this.attrs.event.event_end())), app.session.user && (app.session.user.canModerateEvents || this.attrs.event.user.id === app.session.user.id) ? m("div", null, flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      icon: 'fas fa-edit',
      ...
      className: 'Button Button--icon Button--link'
    })) : '', app.session.user ? m("div", null, flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
      icon: 'fas fa-circle',
      onclick: this.subscribeEvent.bind(this),
      className: 'Button Button--icon Button--link'
    })) : '');
  };
  ...
  _proto.subscribeEvent = function subscribeEvent() {};
...
/* harmony import */ var flarum_utils_affixSidebar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! flarum/utils/affixSidebar */ "flarum/utils/affixSidebar");
/* harmony import */ var flarum_utils_affixSidebar__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(flarum_utils_affixSidebar__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _Models_Event__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Models/Event */ "./src/forum/Models/Event.js");
/* harmony import */ var _EventFragment__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./EventFragment */ "./src/forum/Components/EventFragment.js");
...
var EventPage = /*#__PURE__*/function (_Page) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(EventPage, _Page);
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.event = null; //loadEvent(  m.route.param('id'));

    app.preloadedApiDocument();
    app.store.all('events').some(function (event) {
  ...
  _proto.view = function view() {
    ...
    }, m("h2", null, this.event.name()), m(_EventFragment__WEBPACK_IMPORTED_MODULE_7__["default"], {
      event: this.event
...
var Event = /*#__PURE__*/function (_Model) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(Event, _Model);
  ...
  function Event() {
    ...
    _this.name = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('name');
    _this.description = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('description');
    _this.createdAt = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('createdAt', flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.transformDate);
    _this.event_start = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('event_start', flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.transformDate);
    _this.event_end = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('event_end', flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.transformDate);
    _this.user = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasOne('user');
    _this.mission_id = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('mission_id');
    return _this;
  }
...
/* harmony import */ var _Components_EventPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/EventPage */ "./src/forum/Components/EventPage.js");
...
/* harmony import */ var _Models_Event__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Models/Event */ "./src/forum/Models/Event.js");
...
app.initializers.add('webbinaro-calendar', function () {
  ...
  app.routes.advevent = {
    path: '/events/:id',
    component: _Components_EventPage__WEBPACK_IMPORTED_MODULE_1__["default"]
  };
  app.routes.subscribe = {
    path: '/events/:id/subscribe',
    component: _Components_EventPage__WEBPACK_IMPORTED_MODULE_1__["default"]
  }; //allows easy route generation by passing an event from components (see EventFragment)

  app.route.advevent = function (event) {
    return app.route('advevent', {
      id: event.id()
    });
  };

  app.route.subscribe = function (event) {
    return app.route('subscribe', {
      id: event.id()
    });
  };

  app.store.models.events = _Models_Event__WEBPACK_IMPORTED_MODULE_5__["default"];
  app.store.models.users.prototype.canModerateEvents = flarum_Model__WEBPACK_IMPORTED_MODULE_6___default.a.attribute('canModerateEvents');
  app.store.models.users.prototype.canStartEvents = flarum_Model__WEBPACK_IMPORTED_MODULE_6___default.a.attribute('canStartEvents');
  app.store.models.users.prototype.canViewEvents = flarum_Model__WEBPACK_IMPORTED_MODULE_6___default.a.attribute('canViewEvents'); //add events to side nav
...
/***/ "flarum/utils/affixSidebar":
/*!***********************************************************!*\
  !*** external "flarum.core.compat['utils/affixSidebar']" ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = flarum.core.compat['utils/affixSidebar'];
